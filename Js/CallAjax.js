...
function Llamada2() {
    alert("Pelicula añadida a cartelera correctamente");
...
function Llamada3() {
    ...
    alert("Pelicula eliminada de cartelera correctamente");
...
function Llamada4() {
    alert("Pelicula aactualizada en cartelera correctamente");
